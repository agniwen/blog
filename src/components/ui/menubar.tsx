...
function MenubarCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      className={cn(
        'relative flex cursor-default items-center gap-2.5 rounded-xl py-2 pr-3 pl-8 text-sm outline-hidden select-none focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0',
        className,
      )}
      checked={checked}
      {...props}
...
function MenubarRadioItem({ className, children, ...props }: MenuPrimitive.RadioItem.Props) {
  return (
    <MenuPrimitive.RadioItem
      ...
      className={cn(
        "relative flex cursor-default items-center gap-2.5 rounded-xl py-2 pr-3 pl-8 text-sm outline-hidden select-none focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
...
function MenubarLabel({ className, inset, ...props }: React.ComponentProps<typeof MenuGroupLabel>) {
  return (
    <MenuGroupLabel
      data-slot='menubar-label'
      data-inset={inset}
      className={cn('px-3.5 py-2.5 text-xs text-muted-foreground data-[inset]:pl-8', className)}
      {...props}
    />
  );
}
...
function MenubarSubTrigger({
  ...
  return (
    <MenuSubTrigger
      ...
      data-inset={inset}
      className={cn(
        "gap-2 rounded-xl px-3 py-2 text-sm focus:bg-accent focus:text-accent-foreground data-[inset]:pl-8 data-open:bg-accent data-open:text-accent-foreground [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
...
function MenubarSubContent({ className, ...props }: React.ComponentProps<typeof MenuSubPopup>) {
  return (
    <MenuSubPopup
