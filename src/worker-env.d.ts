/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example src/worker-env.d.ts` (hash: 1fb409bf94c6e35e6b2245436ad74b4c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_ENDPOINT" | "R2_BUCKET_NAME" | "CLOUDFLARE_CDN_URL" | "NEXT_PUBLIC_BETTER_AUTH_URL" | "NEXT_PUBLIC_AVATAR_URL">> {}
}
