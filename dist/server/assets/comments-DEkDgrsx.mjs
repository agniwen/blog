...
const getCommentsServerFn = createServerFn({
  ...
  postId: z.string()
})).handler(getCommentsServerFn_createServerFn_handler, async ({
  data
}) => {
...
const createCommentServerFn = createServerFn({
  ...
  postId: z.string(),
  content: z.string()
})).handler(createCommentServerFn_createServerFn_handler, async ({
  data
}) => {
...
export {
  createCommentServerFn_createServerFn_handler,
  getCommentsServerFn_createServerFn_handler
};
