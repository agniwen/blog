...
import { h as hono, p as parseShortcutKeys, c as cn, i as isNodeInSchema, a as isNodeTypeSelected, f as findNodePosition, b as isValidPosition, u as useIsMobile, d as isMarkInSchema, e as isExtensionAvailable, s as sanitizeUrl, g as focusNextNode, j as handleImageUpload, M as MAX_FILE_SIZE, S as StudioShell, A as AdminContainer } from "./studio-shell-XAoOk8iz.mjs";
import { useForm } from "@tanstack/react-form";
import { useQueryClient, useQuery } from "@tanstack/react-query";
import { useNavigate } from "@tanstack/react-router";
import { parseResponse } from "hono/client";
import { throttle, isNil } from "lodash-es";
import { CornerDownLeftIcon as CornerDownLeftIcon$1, ChevronDownIcon as ChevronDownIcon$1, Sparkles } from "lucide-react";
import * as React from "react";
import { useRef, useEffect, useState, useCallback } from "react";
import { useHotkeys } from "react-hotkeys-hook";
import { toast } from "sonner";
import { useCurrentEditor, useEditorState, EditorContext, EditorContent, NodeViewWrapper, Node, ReactNodeViewRenderer, mergeAttributes, useEditor as useEditor$1 } from "@tiptap/react";
import { FloatingDelayGroup, useMergeRefs, FloatingPortal, useFloating, autoUpdate, offset, flip, shift, useHover, useFocus, useDismiss, useRole, useInteractions } from "@floating-ui/react";
import { TextSelection, NodeSelection } from "@tiptap/pm/state";
import { Popover as Popover$1 } from "@base-ui/react/popover";
import { c as cn$1 } from "./utils-H80jjgLf.mjs";
import { Menu } from "@base-ui/react/menu";
import { I as InputGroup$1, d as InputGroupInput, a as InputGroupTextarea, b as InputGroupAddon } from "./bookmark-node-CwOinFNs.mjs";
import { b as Route } from "./router-CV8uKWT2.mjs";
import { B as Button$1, S as Spinner } from "./button-IvqLSGSY.mjs";
import { d as FieldSet, F as FieldGroup, a as Field, b as FieldLabel, e as FieldError } from "./field-BdRzanoA.mjs";
...
const CloudUploadIcon$1 = () => /* @__PURE__ */ jsxs(
  "svg",
  {
    width: "24",
    height: "24",
...
const FileCornerIcon$1 = () => /* @__PURE__ */ jsx(
  "svg",
  {
    width: "10",
    height: "10",
...
function BannerUpload({ value, onChange, onError }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "banner-upload", children: [
    !previewUrl ? /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        onClick: handleClick,
        children: [
          /* @__PURE__ */ jsxs("div", { className: "banner-upload-dropzone", children: [
            /* @__PURE__ */ jsx(FileIcon$1, {}),
            /* @__PURE__ */ jsx(FileCornerIcon$1, {}),
            /* @__PURE__ */ jsx("div", { className: "banner-upload-icon-container", children: /* @__PURE__ */ jsx(CloudUploadIcon$1, {}) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "banner-upload-content", children: [
            /* @__PURE__ */ jsxs("span", { className: "banner-upload-text", children: [
              /* @__PURE__ */ jsx("em", { children: "Click to upload" }),
              " ",
              "or drag and drop"
            ] }),
            /* @__PURE__ */ jsx("span", { className: "banner-upload-subtext", children: "PNG, JPG, GIF up to 5MB" })
          ] })
        ]
      }
    ) : /* @__PURE__ */ jsxs("div", { className: "banner-upload-preview", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "banner-upload-preview-content", children: [
        /* @__PURE__ */ jsx(
          "img",
          {
            src: previewUrl,
...
const HighlighterIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsx(
      "svg",
      {
...
function TooltipTrigger({ ref: propRef, children, asChild = false, ...props }) {
  ...
  const childrenRef = React.isValidElement(children) ? Number.parseInt(React.version, 10) >= 19 ? children.props.ref : children.ref : void 0;
...
function TooltipContent({ ref: propRef, style, children, portal = true, portalProps = defaultPortalProps, ...props }) {
  const context = useTooltipContext();
...
const ShortcutDisplay = ({
  ...
  if (shortcuts.length === 0)
    return null;
  return /* @__PURE__ */ jsx("div", { children: shortcuts.map((key, index) => /* @__PURE__ */ jsxs(React.Fragment, { children: [
    index > 0 && /* @__PURE__ */ jsx("kbd", { children: "+" }),
    /* @__PURE__ */ jsx("kbd", { children: key })
  ] }, index)) });
};
function Button({ ref, className, children, tooltip, showTooltip = true, shortcutKeys, "aria-label": ariaLabel, ...props }) {
...
function ToolbarSeparator({ ref, ...props }) {
  return /* @__PURE__ */ jsx(Separator, { ref, orientation: "vertical", decorative: true, ...props });
}
ToolbarSeparator.displayName = "ToolbarSeparator";
function Badge({ ref, variant, size = "default", appearance = "default", trimText = false, className, children, ...props }) {
  return /* @__PURE__ */ jsx(
    "div",
    {
      ref,
...
function BlockquoteButton({ ref, editor: providedEditor, text, hideWhenUnavailable = false, onToggled, showShortcut = false, onClick, children, ...buttonProps }) {
...
const BlockquoteIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
function InputGroup({
  ...
  return /* @__PURE__ */ jsx("div", { className: cn("tiptap-input-group", className), ...props, children });
}
function BookmarkPopoverContent({ editor, onClose }) {
  ...
  return /* @__PURE__ */ jsx(
    Card,
    {
      ...
      children: /* @__PURE__ */ jsxs(CardBody, { className: "w-full", children: [
        /* @__PURE__ */ jsxs(CardItemGroup, { orientation: "horizontal", className: "flex", children: [
          /* @__PURE__ */ jsx(InputGroup, { className: "flex-1", children: /* @__PURE__ */ jsx(
            Input,
            {
              type: "url",
          ...
          /* @__PURE__ */ jsx(ButtonGroup, { orientation: "horizontal", children: /* @__PURE__ */ jsx(
            Button,
            {
              ...
              "data-style": "ghost",
              children: /* @__PURE__ */ jsx(CornerDownLeftIcon$1, { className: "tiptap-button-icon" })
            }
          ) })
        ] }),
        error && /* @__PURE__ */ jsx(CardItemGroup, { orientation: "horizontal", children: /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 px-2", children: error }) })
      ] })
    }
  );
}
function BookmarkButton() {
  ...
  return /* @__PURE__ */ jsxs(Popover, { open, onOpenChange: setOpen, children: [
    ...
    /* @__PURE__ */ jsx(PopoverContent, { className: "p-0", children: /* @__PURE__ */ jsx(
...
function CodeBlockButton({ ref, editor: providedEditor, text, hideWhenUnavailable = false, onToggled, showShortcut = false, onClick, children, ...buttonProps }) {
  const { editor } = useTiptapEditor(providedEditor);
  const {
    isVisible,
    canToggle: canToggle2,
...
const CodeBlockIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
function ColorHighlightButton({ ref, editor: providedEditor, highlightColor, text, hideWhenUnavailable = false, onApplied, showShortcut = false, onClick, children, style, ...buttonProps }) {
  const { editor } = useTiptapEditor(providedEditor);
  const {
    isVisible,
...
function ColorHighlightPopoverContent({
  ...
  return /* @__PURE__ */ jsx(
    Card,
    {
      ...
      children: /* @__PURE__ */ jsx(CardBody, { style: isMobile ? { padding: 0 } : {}, children: /* @__PURE__ */ jsxs(CardItemGroup, { orientation: "horizontal", children: [
        /* @__PURE__ */ jsx(ButtonGroup, { orientation: "horizontal", children: colors.map((color, index) => /* @__PURE__ */ jsx(
...
function ColorHighlightPopover({
  ...
  return /* @__PURE__ */ jsxs(Popover, { open: isOpen, onOpenChange: setIsOpen, children: [
    ...
    /* @__PURE__ */ jsx(PopoverContent, { "aria-label": "Highlight colors", className: "p-0", children: /* @__PURE__ */ jsx(ColorHighlightPopoverContent, { editor, colors }) })
  ] });
}
...
function HeadingButton({ ref, editor: providedEditor, level, text, hideWhenUnavailable = false, onToggled, showShortcut = false, onClick, children, ...buttonProps }) {
  const { editor } = useTiptapEditor(providedEditor);
  const {
    isVisible,
    canToggle: canToggle2,
...
const HeadingFiveIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
const HeadingFourIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
const HeadingOneIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
const HeadingSixIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
const HeadingThreeIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
const HeadingTwoIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
function HeadingDropdownMenu({ ref, editor: providedEditor, levels = defaultLevels, hideWhenUnavailable = false, portal = false, onOpenChange, ...buttonProps }) {
  const { editor } = useTiptapEditor(providedEditor);
  const [isOpen, setIsOpen] = React.useState(false);
  ...
  return /* @__PURE__ */ jsxs(DropdownMenu, { modal: true, open: isOpen, onOpenChange: handleOpenChange, children: [
    ...
    /* @__PURE__ */ jsx(DropdownMenuPortal, { children: /* @__PURE__ */ jsx(DropdownMenuContent, { align: "start", portal, children: /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardBody, { children: /* @__PURE__ */ jsx(ButtonGroup, { children: levels.map((level) => /* @__PURE__ */ jsx(
      DropdownMenuItem,
      {
        nativeButton: true,
        render: /* @__PURE__ */ jsx(
...
function useHeadingDropdownMenu(config) {
  ...
  React.useEffect(() => {
    ...
    const handleSelectionUpdate = () => {
      setIsVisible(
        shouldShowButton$5({ editor, hideWhenUnavailable, level: levels })
      );
    };
    handleSelectionUpdate();
    editor.on("selectionUpdate", handleSelectionUpdate);
...
function ImageUploadButton({ ref, editor: providedEditor, text, hideWhenUnavailable = false, onInserted, showShortcut = false, onClick, children, ...buttonProps }) {
  const { editor } = useTiptapEditor(providedEditor);
  const {
    isVisible,
    canInsert,
...
const ImagePlusIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsx(
      "svg",
      {
...
const CornerDownLeftIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsx(
      "svg",
      {
...
const LinkMain = ({
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      style: isMobile ? { boxShadow: "none", border: 0 } : {},
      children: /* @__PURE__ */ jsx(CardBody, { children: /* @__PURE__ */ jsxs(CardItemGroup, { orientation: "horizontal", children: [
...
function LinkPopover({ ref, editor: providedEditor, hideWhenUnavailable = false, onSetLink, onOpenChange, autoOpenOnLinkActive = true, onClick, children, ...buttonProps }) {
  const { editor } = useTiptapEditor(providedEditor);
  const [isOpen, setIsOpen] = React.useState(false);
  const {
    isVisible,
  ...
  return /* @__PURE__ */ jsxs(Popover, { open: isOpen, onOpenChange: handleOnOpenChange, children: [
    /* @__PURE__ */ jsx(
      PopoverTrigger,
      {
        nativeButton: true,
...
function ListButton({ ref, editor: providedEditor, type, text, hideWhenUnavailable = false, onToggled, showShortcut = false, onClick, children, ...buttonProps }) {
  const { editor } = useTiptapEditor(providedEditor);
  const {
    isVisible,
    canToggle: canToggle2,
...
const ListOrderedIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
function ListDropdownMenu({
  ...
  return /* @__PURE__ */ jsxs(DropdownMenu, { open: isOpen, onOpenChange: handleOnOpenChange, children: [
    ...
    /* @__PURE__ */ jsx(DropdownMenuPortal, { children: /* @__PURE__ */ jsx(DropdownMenuContent, { align: "start", portal, children: /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardBody, { children: /* @__PURE__ */ jsx(ButtonGroup, { children: filteredLists.map((option) => /* @__PURE__ */ jsx(
      DropdownMenuItem,
      {
        nativeButton: true,
        render: /* @__PURE__ */ jsx(
...
function MarkButton({ ref, editor: providedEditor, type, text, hideWhenUnavailable = false, onToggled, showShortcut = false, onClick, children, ...buttonProps }) {
  const { editor } = useTiptapEditor(providedEditor);
  const {
    isVisible,
    handleMark,
...
const SubscriptIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
const SuperscriptIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
const UnderlineIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsx(
      "svg",
      {
...
function TextAlignButton({ ref, editor: providedEditor, align, text, hideWhenUnavailable = false, onAligned, showShortcut = false, onClick, icon: CustomIcon, children, ...buttonProps }) {
  const { editor } = useTiptapEditor(providedEditor);
  const {
    isVisible,
    handleTextAlign,
...
const AlignCenterIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
const AlignJustifyIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
const AlignLeftIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
const AlignRightIcon = React.memo(
  ({ className, ...props }) => {
    return /* @__PURE__ */ jsxs(
      "svg",
      {
...
function UndoRedoButton({ ref, editor: providedEditor, action, text, hideWhenUnavailable = false, onExecuted, showShortcut = false, onClick, children, ...buttonProps }) {
  const { editor } = useTiptapEditor(providedEditor);
...
function MainToolbarContent({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(ToolbarGroup, { children: [
      ...
      !isMobile ? /* @__PURE__ */ jsx(ColorHighlightPopover, {}) : /* @__PURE__ */ jsx(ColorHighlightPopoverButton, { onClick: onHighlighterClick }),
      !isMobile ? /* @__PURE__ */ jsx(LinkPopover, {}) : /* @__PURE__ */ jsx(LinkButton, { onClick: onLinkClick })
    ] }),
    /* @__PURE__ */ jsx(ToolbarSeparator, {}),
    /* @__PURE__ */ jsxs(ToolbarGroup, { children: [
...
function MobileToolbarContent({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(ToolbarGroup, { children: /* @__PURE__ */ jsxs(Button, { "data-style": "ghost", onClick: onBack, children: [
    ...
    /* @__PURE__ */ jsx(ToolbarSeparator, {}),
    type === "highlighter" ? /* @__PURE__ */ jsx(ColorHighlightPopoverContent, {}) : /* @__PURE__ */ jsx(LinkContent, {})
  ] });
}
function Editor({ editor }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "editor relative", children: /* @__PURE__ */ jsxs(EditorContext, { value: { editor }, children: [
    /* @__PURE__ */ jsx(
      Toolbar,
      {
        ref: toolbarRef,
        ...
        children: mobileView === "main" ? /* @__PURE__ */ jsx(
          MainToolbarContent,
          {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(ChevronDownIcon$1, { className: "text-muted-foreground top-1/2 right-3.5 size-4 -translate-y-1/2 pointer-events-none absolute select-none", "aria-hidden": "true", "data-slot": "native-select-icon" })
      ]
    }
  );
}
...
const BookmarkNodeView = React.memo(({ node }) => {
  ...
  return /* @__PURE__ */ jsx(NodeViewWrapper, { className: "bookmark-node", children: /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "bookmark-content", children: [
        /* @__PURE__ */ jsxs("div", { className: "bookmark-info", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
            (siteName || favicon) && /* @__PURE__ */ jsxs("div", { className: "bookmark-site", children: [
              ...
              siteName && /* @__PURE__ */ jsx("span", { className: "bookmark-site-name", children: siteName })
            ] }),
            title && /* @__PURE__ */ jsx("div", { className: "bookmark-title", children: title })
          ] }),
          description && /* @__PURE__ */ jsx("div", { className: "bookmark-description text-xs!", children: description }),
          /* @__PURE__ */ jsx("div", { className: "bookmark-url", children: url })
        ] }),
        image && /* @__PURE__ */ jsx("div", { className: "bookmark-image-container", children: /* @__PURE__ */ jsx(
          "img",
          {
            src: image,
            alt: title || "",
...
const IFrameNodeView = React.memo(({ node }) => {
  const { code } = node.attrs;
  return /* @__PURE__ */ jsx(NodeViewWrapper, { className: "iframe-node", children: /* @__PURE__ */ jsx("div", { className: "iframe-container", dangerouslySetInnerHTML: { __html: code } }) });
    ...
    return [
      {
        ...
        getAttrs: (element) => {
          ...
          const code = container?.getAttribute("data-iframe-html") || container?.innerHTML || element.getAttribute("data-code") || "";
          return { code };
        }
      }
    ];
...
const CloudUploadIcon = () => /* @__PURE__ */ jsxs(
  "svg",
  {
    width: "24",
    height: "24",
...
const FileCornerIcon = () => /* @__PURE__ */ jsx(
  "svg",
  {
    width: "10",
    height: "10",
...
const ImageUploadPreview = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "tiptap-image-upload-preview", children: [
    fileItem.status === "uploading" && /* @__PURE__ */ jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxs("div", { className: "tiptap-image-upload-preview-content", children: [
      /* @__PURE__ */ jsxs("div", { className: "tiptap-image-upload-file-info", children: [
        /* @__PURE__ */ jsx("div", { className: "tiptap-image-upload-file-icon", children: /* @__PURE__ */ jsx(CloudUploadIcon, {}) }),
        /* @__PURE__ */ jsxs("div", { className: "tiptap-image-upload-details", children: [
          /* @__PURE__ */ jsx("span", { className: "tiptap-image-upload-text", children: fileItem.file.name }),
          /* @__PURE__ */ jsx("span", { className: "tiptap-image-upload-subtext", children: formatFileSize(fileItem.file.size) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "tiptap-image-upload-actions", children: [
        fileItem.status === "uploading" && /* @__PURE__ */ jsxs("span", { className: "tiptap-image-upload-progress-text", children: [
          fileItem.progress,
          "%"
        ] }),
        /* @__PURE__ */ jsx(
...
const DropZoneContent = ({
  ...
  /* @__PURE__ */ jsxs("div", { className: "tiptap-image-upload-dropzone", children: [
    /* @__PURE__ */ jsx(FileIcon, {}),
    /* @__PURE__ */ jsx(FileCornerIcon, {}),
    /* @__PURE__ */ jsx("div", { className: "tiptap-image-upload-icon-container", children: /* @__PURE__ */ jsx(CloudUploadIcon, {}) })
  ] }),
  /* @__PURE__ */ jsxs("div", { className: "tiptap-image-upload-content", children: [
    /* @__PURE__ */ jsxs("span", { className: "tiptap-image-upload-text", children: [
      /* @__PURE__ */ jsx("em", { children: "Click to upload" }),
      " ",
      "or drag and drop"
    ] }),
    /* @__PURE__ */ jsxs("span", { className: "tiptap-image-upload-subtext", children: [
      "Maximum",
      " ",
      limit,
      " ",
...
const ImageUploadNode$1 = (props) => {
  ...
  return /* @__PURE__ */ jsxs(
    NodeViewWrapper,
    {
      ...
      onClick: handleClick,
      children: [
        !hasFiles && /* @__PURE__ */ jsx(ImageUploadDragArea, { onFile: handleUpload, children: /* @__PURE__ */ jsx(DropZoneContent, { maxSize, limit }) }),
        hasFiles && /* @__PURE__ */ jsxs("div", { className: "tiptap-image-upload-previews", children: [
          fileItems.length > 1 && /* @__PURE__ */ jsxs("div", { className: "tiptap-image-upload-header", children: [
          ...
          fileItems.map((fileItem) => /* @__PURE__ */ jsx(
            ImageUploadPreview,
            {
              fileItem,
...
function UpsertEditor(props) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row h-[calc(100vh-82px)] overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "editor-form w-full md:w-xs overflow-y-auto md:order-2 border-b md:border-b-0 md:border-l border-(--tt-toolbar-border-color)", children: /* @__PURE__ */ jsx("div", { className: "md:sticky md:top-0 p-2 bg-[--tt-background-color]", children: /* @__PURE__ */ jsx(
      "form",
      {
        onSubmit: (e) => {
          e.preventDefault();
        ...
        children: /* @__PURE__ */ jsx(FieldSet, { children: /* @__PURE__ */ jsxs(FieldGroup, { children: [
          /* @__PURE__ */ jsx(form.Field, { name: "banner", children: (field) => {
          ...
          /* @__PURE__ */ jsx(form.Field, { name: "title", children: (field) => {
            ...
            return /* @__PURE__ */ jsxs(Field, { "data-invalid": inValid, children: [
              /* @__PURE__ */ jsx(FieldLabel, { children: "Title" }),
              /* @__PURE__ */ jsx(InputGroup$1, { children: /* @__PURE__ */ jsx(
                InputGroupInput,
                {
                  placeholder: "请输入标题",
                  value: field.state.value,
          ...
          /* @__PURE__ */ jsx(form.Field, { name: "slug", children: (field) => {
            const isValid = field.state.meta.isTouched && !field.state.meta.isValid;
            return /* @__PURE__ */ jsxs(Field, { "data-invalid": isValid, children: [
          ...
          /* @__PURE__ */ jsx(form.Field, { name: "summary", children: (field) => {
            const isValid = field.state.meta.isTouched && !field.state.meta.isValid;
            return /* @__PURE__ */ jsxs(Field, { "data-invalid": isValid, children: [
              /* @__PURE__ */ jsx(FieldLabel, { children: "Summary" }),
              /* @__PURE__ */ jsxs(InputGroup$1, { children: [
                /* @__PURE__ */ jsx(
                  InputGroupTextarea,
                  {
                ...
                /* @__PURE__ */ jsx(InputGroupAddon, { align: "block-end", children: /* @__PURE__ */ jsx("div", { className: "flex w-full justify-end", children: /* @__PURE__ */ jsxs(Button$1, { variant: "ghost", size: "sm", className: "rounded-full", children: [
          ...
          /* @__PURE__ */ jsx(form.Field, { name: "published", children: (field) => {
            return /* @__PURE__ */ jsxs(Field, { children: [
              ...
              /* @__PURE__ */ jsxs(
                NativeSelect,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx(NativeSelectOption, { value: "false", children: "Draft" }),
                    /* @__PURE__ */ jsx(NativeSelectOption, { value: "true", children: "Published" })
                  ]
                }
              ),
              /* @__PURE__ */ jsx(FieldError, { errors: field.state.meta.errors })
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto md:order-1 relative", children: [
      isSaving && /* @__PURE__ */ jsxs("div", { className: "fixed top-30 left-0 right-0 w-fit mx-auto z-10 flex items-center gap-2 px-3 py-1.5 rounded-full bg-background/80 backdrop-blur-sm border border-border shadow-sm text-sm text-muted-foreground", children: [
...
function StudioPostUpsertPage() {
  ...
  return /* @__PURE__ */ jsx(StudioShell, { children: /* @__PURE__ */ jsx(AdminContainer, { className: "h-full", children: /* @__PURE__ */ jsx(UpsertEditor, { id }) }) });
}
export {
  StudioPostUpsertPage as component
};
