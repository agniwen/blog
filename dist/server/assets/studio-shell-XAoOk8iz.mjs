...
function AdminContainer(props) {
  ...
  return /* @__PURE__ */ jsx("div", {
    className: cn("admin-container pt-2", className),
    ...restProps,
  });
}
...
function Tooltip({ ...props }) {
  return /* @__PURE__ */ jsx(TooltipProvider, {
    children: /* @__PURE__ */ jsx(Tooltip$1.Root, { "data-slot": "tooltip", ...props }),
  });
}
...
function SidebarGroup({ className, ...props }) {
  return /* @__PURE__ */ jsx("div", {
    ...
    "data-sidebar": "group",
    className: cn$1("p-2 relative flex w-full min-w-0 flex-col", className),
    ...props,
  });
}
...
function AvatarImage({ className, ...props }) {
  return /* @__PURE__ */ jsx(Avatar$1.Image, {
    ...
    className: cn$1("rounded-full aspect-square size-full object-cover", className),
    ...props,
  });
}
      ...
      children: /* @__PURE__ */ jsxs(DropdownMenu, {
        children: [
          /* @__PURE__ */ jsx(DropdownMenuTrigger, {
            render: /* @__PURE__ */ jsxs(SidebarMenuButton, {
              size: "lg",
              className:
                ...
                /* @__PURE__ */ jsxs(Avatar, {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx(AvatarFallback, {
                      ...
                      children: data?.user.name.slice(0, 2),
                    }),
                  ],
                }),
                /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      /* @__PURE__ */ jsx(SidebarHeader, {
        children: /* @__PURE__ */ jsx(SidebarMenuButton, {
          size: "lg",
          render: /* @__PURE__ */ jsxs("a", {
            href: "#",
            children: [
              /* @__PURE__ */ jsx("div", {
                className:
                  "bg-primary/5  flex aspect-square size-8 items-center justify-center rounded-md",
                children: /* @__PURE__ */ jsx(CitrusIcon, { className: "size-5 text-primary" }),
              }),
              /* @__PURE__ */ jsx("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx(SidebarGroupContent, {
                  children: /* @__PURE__ */ jsx(SidebarMenu, {
                    children: menuGroup.children.map((menu) => {
                      return /* @__PURE__ */ jsx(
                        SidebarMenuItem,
                        {
                          children: /* @__PURE__ */ jsx(SidebarMenuButton, {
      ...
      /* @__PURE__ */ jsxs(SidebarInset, {
        children: [
          /* @__PURE__ */ jsxs("header", {
            ...
            children: [
              /* @__PURE__ */ jsx("div", {
                children: /* @__PURE__ */ jsx(SidebarTrigger, { className: "-ml-1" }),
              }),
              /* @__PURE__ */ jsx("div", {
                className: "flex items-center gap-2",
                children: /* @__PURE__ */ jsx(AppThemeToggle, {}),
              }),
            ],
          }),
          /* @__PURE__ */ jsx(ScrollArea, {
            className: "max-h-[calc(100vh-66px)] pb-2 px-2",
            children,
          }),
        ],
      }),
