...
function PostCardLoader() {
  ...
  return /* @__PURE__ */ jsxs(
    ContentLoader,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("rect", { x: "0", y: "0", rx: "8", ry: "8", width: "400", height: "200" }),
        /* @__PURE__ */ jsx("rect", { x: "0", y: "215", rx: "4", ry: "4", width: "300", height: "16" }),
        /* @__PURE__ */ jsx("rect", { x: "0", y: "240", rx: "4", ry: "4", width: "400", height: "12" }),
        /* @__PURE__ */ jsx("rect", { x: "0", y: "260", rx: "4", ry: "4", width: "400", height: "12" }),
        /* @__PURE__ */ jsx("rect", { x: "0", y: "280", rx: "4", ry: "4", width: "200", height: "10" })
      ]
    }
  );
}
function PostsLoader() {
  return /* @__PURE__ */ jsx("div", { className: "posts pb-4", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:flex 2xl:flex-wrap gap-4", children: [
...
function Posts() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "posts pb-4", children: /* @__PURE__ */ jsx("div", { className: cn("grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:flex 2xl:flex-wrap gap-4", isFetching && "opacity-80"), children: posts?.data.map((post) => {
      return /* @__PURE__ */ jsxs(ContextMenu, { children: [
        /* @__PURE__ */ jsx(
          ContextMenuTrigger,
          {
            render: /* @__PURE__ */ jsx(Link, { to: "/studio/posts/upsert/$id", params: { id: post.id }, className: "block 2xl:w-xs", children: /* @__PURE__ */ jsx(PostCard, { className: "h-full", post }) })
          }
        ),
        /* @__PURE__ */ jsx(ContextMenuContent, { children: /* @__PURE__ */ jsxs(ContextMenuItem, { onClick: () => handleSelectDeletePost(post.id), children: [
          /* @__PURE__ */ jsx(Trash2Icon, {}),
          "Delete"
        ] }) })
      ] }, post.id);
    }) }) }),
    /* @__PURE__ */ jsx(AlertDialog, { open: confirmDialogOpen, onOpenChange: setConfirmDialogOpen, children: /* @__PURE__ */ jsxs(AlertDialogContent, { children: [
      /* @__PURE__ */ jsxs(AlertDialogHeader, { children: [
        /* @__PURE__ */ jsx(AlertDialogTitle, { children: "Are you sure?" }),
        /* @__PURE__ */ jsx(AlertDialogDescription, { children: "This action cannot be undone. This will permanently delete the post." })
      ] }),
      /* @__PURE__ */ jsxs(AlertDialogFooter, { children: [
        /* @__PURE__ */ jsx(AlertDialogCancel, { children: "Cancel" }),
        /* @__PURE__ */ jsx(Button, { onClick: () => deletePostId && handleDelete(deletePostId), children: "Delete" })
      ] })
    ] }) })
  ] });
}
...
function PostsRefreshButton() {
  ...
  return /* @__PURE__ */ jsx(Button, { onClick: handleRefresh, variant: "secondary", children: "Refresh" });
}
function StudioPostsPage() {
  return /* @__PURE__ */ jsx(StudioShell, { children: /* @__PURE__ */ jsxs(AdminContainer, { className: "space-y-4", children: [
