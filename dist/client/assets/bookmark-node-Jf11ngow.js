import { j as r } from "./main-Cq61YlVT.js";
import { B as u, a as o } from "./button-DCFLH-17.js";
import { I as d } from "./separator-DbLTj1dh.js";
import { c as n } from "./utils-8lG47UID.js";
...
function m({ className: a, align: t = "inline-start", ...e }) {
  return r.jsx("div", {
    role: "group",
...
const c = o("gap-2 rounded-4xl text-sm shadow-none flex items-center", {
  variants: {
    size: {
...
function v({ className: a, type: t = "button", variant: e = "ghost", size: i = "xs", ...s }) {
  return r.jsx(u, { type: t, "data-size": i, variant: e, className: n(c({ size: i }), a), ...s });
}
...
export { h as I, j as a, m as b, v as c, k as d };
