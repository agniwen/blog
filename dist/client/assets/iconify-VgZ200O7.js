import { r as v } from "./main-Cq61YlVT.js";
function ye(e, n) {
  const o = e.icons,
...
function se(e) {
  ...
  const n = e;
  if (typeof n.prefix != "string" || !e.icons || typeof e.icons != "object" || !D(e, Ie))
    return null;
  const o = n.icons;
  for (const t in o) {
    const r = o[t];
...
function we(e, n) {
  return { provider: e, prefix: n, icons: Object.create(null), missing: new Set() };
}
function T(e, n) {
...
function Se(e, n) {
  ...
  return n ? ve(i, o.name, n) : (i.missing.add(o.name), !0);
}
function ke(e, n) {
...
function Ce(e, n = "defs") {
  ...
  for (; i >= 0; ) {
    ...
    const s = e.indexOf(">", r);
    if (s === -1) break;
    ((o += e.slice(t + 1, r).trim()), (e = e.slice(0, i).trim() + e.slice(s + 1)));
  }
...
function Fe(e, n) {
  ...
  [o, i].forEach((x) => {
    ...
    (b % 2 === 1 &&
      ...
      t.width !== t.height && ((I = t.width), (t.width = t.height), (t.height = I))),
  ...
  s === null
    ...
    : ((u = s === "auto" ? c : s), (d = l === null ? K(u, f / c) : l === "auto" ? f : l));
  const p = {},
    g = (x, a) => {
      Oe(a) || (p[x] = a.toString());
    };
...
const Le = /\sid="(\S+)"/g,
  Ae = "IconifyId" + Date.now().toString(16) + ((Math.random() * 16777216) | 0).toString(16);
let Me = 0;
function Ne(e, n = Ae) {
  const o = [];
  let i;
  ...
  return (
    o.forEach((r) => {
      const s = typeof n == "function" ? n(r) : n + (Me++).toString(),
        l = r.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
      e = e.replace(new RegExp('([#;"])(' + l + ')([")]|\\.[a-z])', "g"), "$1" + s + t + "$3");
    }),
  ...
  return (
    o.forEach((c, f) => {
      ((l += c.length + 1),
        l >= t &&
          f > 0 &&
          (i.push(s), (s = { type: r, provider: e, prefix: n, icons: [] }), (l = c.length)),
        s.icons.push(c));
    }),
    i.push(s),
    i
    ...
    setTimeout(() => {
      ...
      n.forEach((r) => {
        ...
        ((s.pending = s.pending.filter((c) => {
          ...
          else if (e.missing.has(f)) s.missing.push({ provider: i, prefix: t, name: f });
          else return ((o = !0), !0);
          return !1;
        })),
          s.pending.length !== l &&
            (o || de([e], r.id),
            r.callback(s.loaded.slice(0), s.missing.slice(0), s.pending.slice(0), r.abort)));
      });
    }));
}
let Ge = 0;
...
const Ke = { resources: [], index: 0, timeout: 2e3, rotate: 750, random: !1, dataAfterTimeout: !1 };
function Xe(e, n, o, i) {
...
function nt(e, n) {
  (e.iconsToLoad ? (e.iconsToLoad = e.iconsToLoad.concat(n).sort()) : (e.iconsToLoad = n),
    e.iconsQueueFlag ||
      ((e.iconsQueueFlag = !0),
      setTimeout(() => {
        e.iconsQueueFlag = !1;
...
const yt = (e, n, o) => {
  ...
  if (o) {
    ...
    if (a) {
      const h = ["iconify"],
        S = ["provider", "prefix"];
      for (const b of S) a[b] && h.push("iconify--" + a[b]);
      c.className = h.join(" ");
    }
  }
  for (let a in n) {
    ...
    if (h !== void 0)
      switch (a) {
        ...
        case "color":
          ...
          break;
        case "rotate":
          typeof h == "string" ? (t[a] = ct(h)) : typeof h == "number" && (t[a] = h);
          break;
        case "ariaHidden":
        case "aria-hidden":
...
const bt = v.forwardRef((e, n) => me({ ...e, _ref: n }));
v.forwardRef((e, n) => me({ inline: !0, ...e, _ref: n }));
export { bt as I };
