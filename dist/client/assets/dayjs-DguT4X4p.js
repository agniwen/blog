import { d as X } from "./main-Cq61YlVT.js";
var B = { exports: {} },
  rt = B.exports,
  G;
function nt() {
        ...
        (function (w, x) {
          ...
          var w = 1e3,
            ...
            j = {
              ...
              p: function (i) {
                return (
                  { M: l, y: g, w: y, d: c, D: S, h: b, m: O, s: _, ms: D, Q: W }[i] ||
                  String(i || "")
                    .toLowerCase()
                    .replace(/s$/, "")
                );
          ...
          var A = "$isDayjsObject",
            ...
            h = function (i, r) {
              ...
              return ((t.date = i), (t.args = arguments), new R(t));
            },
            a = j;
          ((a.l = J),
            (a.i = H),
            (a.w = function (i, r) {
              return h(i, { locale: r.$L, utc: r.$u, x: r.$x, $offset: r.$offset });
            }));
          var R = (function () {
              function i(t) {
              ...
              return (
                  ...
                  ((this.$d = (function (n) {
                    ...
                    if (typeof e == "string" && !/Z$/i.test(e)) {
                      ...
                      if (u) {
                        ...
                        return s
                          ? new Date(
                              Date.UTC(u[1], o, u[3] || 1, u[4] || 0, u[5] || 0, u[6] || 0, f),
                            )
                          : new Date(u[1], o, u[3] || 1, u[4] || 0, u[5] || 0, u[6] || 0, f);
                      }
                    }
                    return new Date(e);
                  })(t)),
                ...
                (r.startOf = function (t, n) {
                  var e = this,
                    ...
                    u = a.p(t),
                    o = function (L, M) {
                      var T = a.w(e.$u ? Date.UTC(e.$y, M, L) : new Date(e.$y, M, L), e);
                      return s ? T : T.endOf(c);
                    },
                    f = function (L, M) {
                      return a.w(
                        e
                          .toDate()
                          [L].apply(e.toDate("s"), (s ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(M)),
                        e,
                      );
                    },
                    d = this.$W,
                ...
                (r.add = function (t, n) {
                  ...
                  var u = a.p(n),
                    o = function ($) {
                      var p = h(s);
                      return a.w(p.date(p.date() + Math.round($ * t)), s);
                    };
                  if (u === l) return this.set(l, this.$M + t);
                  if (u === g) return this.set(g, this.$y + t);
                  if (u === c) return o(1);
                  if (u === y) return o(7);
                  var f = ((e = {}), (e[O] = x), (e[b] = k), (e[_] = w), e)[u] || 1,
                    d = this.$d.getTime() + t * f;
                  return a.w(d, this);
                }),
                ...
                (r.format = function (t) {
                  ...
                  var s = t || "YYYY-MM-DDTHH:mm:ssZ",
                    ...
                    N = e.meridiem,
                    C = function (M, T, E, Z) {
                      return (M && (M[T] || M(n, s))) || E[T].slice(0, Z);
                    },
                    z = function (M) {
                    ...
                    L =
                      ...
                      function (M, T, E) {
                        var Z = M < 12 ? "AM" : "PM";
                        return E ? Z.toLowerCase() : Z;
                      };
                  return s.replace(q, function (M, T) {
                    return (
                      T ||
                      (function (E) {
                        switch (E) {
                ...
                (r.diff = function (t, n, e) {
                  var s,
                    ...
                    o = a.p(n),
                    f = h(t),
                    d = (f.utcOffset() - this.utcOffset()) * x,
                    $ = this - f,
                    p = function () {
                      return a.m(u, f);
                    };
          ...
          return (
            ...
            (h.extend = function (i, r) {
              return (i.$i || (i(r, R, h), (i.$i = !0)), h);
            }),
            (h.locale = J),
            (h.isDayjs = H),
            (h.unix = function (i) {
      ...
      (function (P, et) {
        (function (w, x) {
          ...
          return function (w, x, k) {
            ...
            ((k.en.relativeTime = _),
              (D.fromToBase = function (c, y, l, W, g) {
                for (
                  var S,
                    Y,
                    I,
                    q = l.$locale().relativeTime || _,
                    F = w.thresholds || [
                      { l: "s", r: 44, d: "second" },
                      { l: "m", r: 89 },
                      { l: "mm", r: 44, d: "minute" },
                  ...
                  var v = (w.rounding || Math.round)(Math.abs(S));
                  if (((I = S > 0), v <= m.r || !m.r)) {
                    v <= 1 && j > 0 && (m = F[j - 1]);
                    var A = q[m.l];
                    (g && (v = g("" + v)),
                      (Y = typeof A == "string" ? A.replace("%d", v) : A(v, y, m.l, I)));
                    break;
                  }
                }
                if (y) return Y;
                var H = I ? q.future : q.past;
            ...
            ((D.toNow = function (c) {
              return this.to(b(this), c);
            }),
              (D.fromNow = function (c) {
                return this.from(b(this), c);
              }));
          };
        });
      })(V)),
