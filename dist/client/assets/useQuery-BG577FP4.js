...
var $ = class extends G {
  ...
  destroy() {
    ((this.listeners = new Set()), this.#y(), this.#S(), this.#t.removeObserver(this));
  }
  setOptions(t) {
    ...
    if (
      ...
      this.options.enabled !== void 0 &&
        ...
        typeof l(this.options.enabled, this.#t) != "boolean")
    )
    ...
    (r && H(this.#t, s, this.options, e) && this.#c(),
      this.updateResult(),
      r &&
        (this.#t !== s ||
          l(this.options.enabled, this.#t) !== l(e.enabled, this.#t) ||
      ...
      get: (s, r) => (
        ...
        r === "promise" &&
          ...
          !this.options.experimental_prefetchInRender &&
            ...
            this.#r.reject(new Error("experimental_prefetchInRender feature flag is not enabled"))),
        Reflect.get(s, r)
      ),
    });
  }
  ...
  #c(t) {
    ...
    return (t?.throwOnError || (e = e.catch(x)), e);
  }
  #R() {
    this.#y();
    const t = g(this.options.staleTime, this.#t);
    if (M || this.#e.isStale || !B(t)) return;
  ...
  #m(t) {
    (this.#S(),
      (this.#n = t),
      !(M || l(this.options.enabled, this.#t) === !1 || !B(this.#n) || this.#n === 0) &&
  ...
  createResult(t, e) {
    ...
    if (e.placeholderData !== void 0 && o === void 0 && b === "pending") {
      let c;
      (i?.isPlaceholderData && e.placeholderData === a?.placeholderData
        ? ((c = i.data), (D = !0))
        : (c =
            typeof e.placeholderData == "function"
              ? e.placeholderData(this.#d?.state.data, this.#d)
              : e.placeholderData),
        c !== void 0 && ((b = "success"), (o = A(i?.data, c, e)), (v = !0)));
    }
    if (e.select && o !== void 0 && !D)
      if (i && o === u?.data && e.select === this.#b) o = this.#l;
      else
        try {
          ((this.#b = e.select),
            (o = e.select(o)),
    ...
    const I = n.fetchStatus === "fetching",
      T = b === "pending",
      w = b === "error",
      F = T && I,
      k = o !== void 0,
      p = {
        ...
        isFetchedAfterMount:
          n.dataUpdateCount > R.dataUpdateCount || n.errorUpdateCount > R.errorUpdateCount,
        isFetching: I,
        isRefetching: I && !T,
        isLoadingError: w && !k,
    ...
    if (this.options.experimental_prefetchInRender) {
      const c = p.data !== void 0,
        m = p.status === "error" && !c,
        S = (O) => {
          m ? O.reject(p.error) : c && O.resolve(p.data);
        },
        L = () => {
          const O = (this.#r = p.promise = N());
          S(O);
        },
        E = this.#r;
      switch (E.status) {
  ...
  updateResult() {
    ...
    const s = () => {
      ...
      const u = new Set(i ?? this.#f);
      return (
        this.options.throwOnError && u.add("error"),
        Object.keys(this.#e).some((a) => {
          const f = a;
  ...
  #O(t) {
    z.batch(() => {
      (t.listeners &&
        ...
        this.#s.getQueryCache().notify({ query: this.#t, type: "observerResultsUpdated" }));
    });
  }
};
function q(t, e) {
...
function H(t, e, s, r) {
  return (
    (t !== e || l(r.enabled, t) === !1) && (!s.suspense || t.state.status !== "error") && P(t, s)
  );
}
function P(t, e) {
...
var rt = d.createContext(st()),
  ...
  ot = ({ result: t, errorResetBoundary: e, throwOnError: s, query: r, suspense: i }) =>
    t.isError &&
    !e.isReset() &&
    !t.isFetching &&
    r &&
  ...
  ct = (t, e) => t.isLoading && t.isFetching && !e,
  ut = (t, e) => t?.suspense && e.isPending,
  W = (t, e, s) =>
...
function lt(t, e, s) {
  const r = et(),
    i = it(),
    u = Z(),
    a = u.defaultQueryOptions(t);
  u.getDefaultOptions().queries?._experimental_beforeQuery?.(a);
  const f = u.getQueryCache().get(a.queryHash);
  ((a._optimisticResults = r ? "isRestoring" : "optimistic"), ht(a), nt(a, i, f), at(i));
  const R = !u.getQueryCache().get(a.queryHash),
    [h] = d.useState(() => new e(u, a)),
    n = h.getOptimisticResult(a),
    v = !r && t.subscribed !== !1;
  if (
    (d.useSyncExternalStore(
      d.useCallback(
        (o) => {
          const y = v ? h.subscribe(z.batchCalls(o)) : x;
  ...
  if (
    ...
    throw n.error;
  return (
    u.getDefaultOptions().queries?._experimental_afterQuery?.(a, n),
    a.experimental_prefetchInRender &&
      !M &&
      ct(n, r) &&
      (R ? W(a, h, i) : f?.promise)?.catch(x).finally(() => {
        h.updateResult();
      }),
